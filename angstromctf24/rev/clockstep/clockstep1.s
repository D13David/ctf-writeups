...
shuffleInput:   LDY #$AB
        STY shufPtr1            ; shufPtr1 = 0xAB
        LDY #$00
        STY shufPtr2            ; shufPtr2 = 0x00
shufLoop:   LDA #$80
        STA shufMask            ; shufMask = 0x80
shufLoop2:  
801b    .byte   $02             ; A = SecureStorage[Y]
801c    AND shufMask
801e    BEQ shufSkip
        STY shufTemp0
        LDA shufPtr1
...
803f    STA input,X
8042    PLA
8043    STA input,Y         ; input[X] <=> input[Y]
8046    LDA shufMask
        ADC #$E3
        STA shufTemp1
        LDA shufPtr1
