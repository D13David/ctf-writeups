...
## Note
The challenge source code can be found [`here`](https://github.com/D13David/obfuscation-peb-walk/blob/v1t_challenge/src/main.cpp). The source code was published only **AFTER** the event finished.
